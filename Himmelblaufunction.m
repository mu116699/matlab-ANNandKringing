...
samplevalue = (sampletotal(1,:).^2+sampletotal(2,:)-11)...
    .^2+(sampletotal(1,:)+sampletotal(2,:).^2-7).^2;
...
test_y_true = (test_x_true(1,:).^2+test_x_true(2,:)-11)...
    .^2+(test_x_true(1,:)+test_x_true(2,:).^2-7).^2
