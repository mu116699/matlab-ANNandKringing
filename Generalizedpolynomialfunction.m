...
samplevalue = (1.5 - sampletotal(1,:).*...
    (1-sampletotal(2,:))).^2+(2.25 - sampletotal(1,:).*...
    (1-sampletotal(2,:).^2)).^2+(2.625 - sampletotal(1,:).*...
    (1-sampletotal(2,:).^3)).^2;
%随机采样
...
test_y_true = (1.5 - test_x_true(1,:).*...
    (1-test_x_true(2,:))).^2+(2.25 - test_x_true(1,:).*...
    (1-test_x_true(2,:).^2)).^2+(2.625 - test_x_true(1,:).*...
    (1-test_x_true(2,:).^3)).^2;
